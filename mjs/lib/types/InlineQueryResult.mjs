...
export default class InlineQueryResult {
  static from(type, id, options) {
    return new InlineQueryResult(type, id, options)
  }
  ...
  setInputMessageContent(content) {
    this.inputMessageContent = content ? (
      content instanceof InputMessageContent ? content : new InputMessageContent(content)
    ) : undefined
    return this
  }
  ...
  toParams() {
    ...
    switch (this.type) {
      ...
      case InlineQueryResultType.MPEG4_GIF: {
        if (this.fileId) {
