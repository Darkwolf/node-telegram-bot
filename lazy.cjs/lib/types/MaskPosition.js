...
class MaskPosition {
  ...
  get isForehead() {
    return this.point === constants.MaskPositionPoint.FOREHEAD
  }

  get isEyes() {
    return this.point === constants.MaskPositionPoint.EYES
  }

  get isMouth() {
    return this.point === constants.MaskPositionPoint.MOUTH
  }

  get isChin() {
    return this.point === constants.MaskPositionPoint.CHIN
  }
