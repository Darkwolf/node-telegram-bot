...
class SuccessfulPayment {
  ...
  setOrderInfo(orderInfo) {
    this.orderInfo = orderInfo ? (
      orderInfo instanceof types.OrderInfo ? orderInfo : new types.OrderInfo(orderInfo, this.context)
    ) : undefined
    return this
  }
...
SuccessfulPayment.from = (data, context) => new SuccessfulPayment(data, context)
SuccessfulPayment.fromParams = (params = {}, context) => {
  const data = {
  ...
  if (data.orderInfo) {
    data.orderInfo = types.OrderInfo.fromParams(data.orderInfo, context)
  }
