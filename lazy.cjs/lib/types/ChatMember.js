...
class ChatMember {
  ...
  get isCreator() {
    return this.status === constants.ChatMemberStatus.CREATOR
  }

  get isAdmin() {
    return this.status === constants.ChatMemberStatus.ADMIN
  }

  get isMember() {
    return this.status === constants.ChatMemberStatus.MEMBER || !!this.member
  }

  get isRestricted() {
    return this.status === constants.ChatMemberStatus.RESTRICTED
  }

  get isLeft() {
    return this.status === constants.ChatMemberStatus.LEFT
  }

  get isKicked() {
    return this.status === constants.ChatMemberStatus.KICKED
  }
